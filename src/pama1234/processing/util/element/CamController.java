...
public class CamController extends Entity{
  ...
  public CamController(UtilApp p,float x,float y,float z) {
    super(p);
  ...
  public void update() {
    ...
    //    screenWidth=(p.width/2)/scale.pos;
    //    screenHeight=(p.height/2)/scale.pos;
    //    PApplet.println(p.width/2,p.height/2);
  }
  @Override
  public void display() {
    p.setMatrix(matrix);
